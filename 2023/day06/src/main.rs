fn main() {
    ...
    println!("Results for A: {}", multiply_possible_hold_time(races));

    println!("Results for B: {}", multiply_possible_hold_time(vec!((58819676, 434104122191218))));
}

fn possible_hold_time(race_time:u64, distance_record:u64) -> u64 {
...
fn multiply_possible_hold_time(races: Vec<(u64, u64)>) -> u64 {
